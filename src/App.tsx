...
import {HomePage, PlayerPage, PrivacyPolicyPage, TermsOfServicePage, HelpPage, ServerDetailsPage, SettingsPage} from "./components";
import {settings, history} from "./lib";
      ...
      <Router history={history}>
        <div className="body">
          <div className="navbar">
            ...
            <a className="btn icon" href="https://github.com/bzlist/bzlist.net-react" target="_blank" rel="noopener noreferrer">
            ...
            <Link to="/" className="btn icon">&#xE77B;</Link>
          </div>
          <div style={{flex: 1}}>
            <Switch>
