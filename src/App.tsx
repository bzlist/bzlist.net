...
const ServerRow = ({server}: {server: Server}) => (
  <tr>
    ...
    <td key={server.configuration.gameStyle}>{server.configuration.gameStyle}</td>
...
class App extends React.Component<any, State>{
  constructor(props: React.Props<any>){
    ...
    const socket = io.connect("https://api.bzlist.net");
    socket.emit("servers");
    socket.on("servers", (data: Server[]) => {
      ...
      <div>
        ...
        <footer>
          <div className="links">
            ...
            <a href="https://bzlist.net/privacy-policy">Privacy Policy</a>
          </div>
