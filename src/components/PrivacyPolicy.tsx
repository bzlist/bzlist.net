...
export const PrivacyPolicy = (): JSX.Element => (
  <div className="wrapper">
    ...
    <p>Your privacy is important to me. It is BZList's policy to respect your privacy regarding any information I may collect from you across my website, <a href="https://bzlist.net">https://bzlist.net</a>, and other sites I own and operate.</p>
    ...
    <ul>
      <li><b>Settings</b> - Your settings are stored only on your computer unless you sign in and turn on settings sync.</li>
      <li><b>Account</b> - If you sign in with your BZFlag account your callsign, BZID and settings (if chosen) will be stored in a database.</li>
      <li><b>IP Address and Browser Info</b> - Your IP adress and browser info isn't used except for some analytics. This is purely for me to know how the site is doing and will not affect any services provided.</li>
    </ul>
