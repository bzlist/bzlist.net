  ...
  render(): JSX.Element{
    return (
      ...
      >
        ...
        <td>
          <span aria-label={this.props.server.country}><img src={`/images/country-flags/${this.props.server.countryCode.toLowerCase()}.svg`} alt={this.props.server.countryCode}/></span>
        </td>
