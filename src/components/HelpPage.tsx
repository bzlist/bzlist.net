...
export const HelpPage = (): JSX.Element => (
  <div className="wrapper">
    ...
    <p><small>Release version <a href={`https://github.com/bzlist/bzlist.net/releases/tag/v${version}`} target="_blank" rel="noopener noreferrer">v{version}</a> See <a href={`https://github.com/bzlist/bzlist.net/compare/v${version}...master`} target="_blank" rel="noopener noreferrer">what's new</a>. View <Link to="/changelog">changelog</Link>.</small></p>
  </div>
);
